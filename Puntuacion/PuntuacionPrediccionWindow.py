...
class BotonPredecir(QPushButton):
    ...
    def predecir(self):
        ...
        if(datosMiEquipo and fichero_modelo):
            df_plantilla = JSONUtil.get_plantilla_puntuacion()
...
class TablaPrediccionesPlantilla(QTableWidget):
    ...
    def cargarDatos(self, df):
        ...
        col_precio_hoy = None
        col_precio_predecido = df.columns.get_loc('Puntuacion predecida')
        col_precio_hoy = df.columns.get_loc('Puntos totales')
